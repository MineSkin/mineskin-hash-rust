...
// https://github.com/GeyserMC/global_api/blob/dev/1.0.2/native/skins/src/skin_convert/pixel_cleaner.rs
pub fn clear_unused_pixels(raw_data: &mut [u8], is_classic: bool) -> &mut [u8] {
